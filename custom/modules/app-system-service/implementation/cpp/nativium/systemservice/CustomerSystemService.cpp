...
CustomerSystemServiceLoginData CustomerSystemService::login(const std::string &username, const std::string &password)
{
    ...
    auto httpURL = "https://raw.githubusercontent.com/nativium/nativium.github.io/main/extras/http-test/login-success.json";

    if (username != "demo" || password != "demo")
    {
        httpURL = "https://raw.githubusercontent.com/nativium/nativium.github.io/main/extras/http-test/login-error.json";
    }
