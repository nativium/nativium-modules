...
#import "nativium/data/NTVSharedData+Private.h"
#import "nativium/data/NTVSharedData.h"
...
@interface NTVSharedData ()

- (id)initWithCpp:(const std::shared_ptr<::nativium::data::SharedData>&)cppRef;

@end

@implementation NTVSharedData {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::nativium::data::SharedData>> _cppRefHandle;
}
...
+ (nullable NTVSharedData *)shared {
    try {
        auto objcpp_result_ = ::nativium::data::SharedData::shared();
        return ::djinni_generated::SharedData::fromCpp(objcpp_result_);
    } DJINNI_TRANSLATE_EXCEPTIONS()
}

- (void)setPlatformService:(nullable id<NTVSharedDataPlatformService>)ps {
    try {
        _cppRefHandle.get()->setPlatformService(::djinni_generated::SharedDataPlatformService::toCpp(ps));
    } DJINNI_TRANSLATE_EXCEPTIONS()
}

- (nullable id<NTVSharedDataPlatformService>)getPlatformService {
    try {
...
auto SharedData::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<NTVSharedData>(cpp);
}
