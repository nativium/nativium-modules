...
class NTVDomainDeviceData final {
public:
...
private:
    NTVDomainDeviceData();
    friend ::djinni::JniClass<NTVDomainDeviceData>;

    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("com/nativium/domain/DeviceData") };
